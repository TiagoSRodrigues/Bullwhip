...
######################################################################
    def save_inventory(self):
        ...
        logs.append_line_to_file(file_path=f"{sim_cfg.FINAL_EXPORT_FILES_PATH}inventory_actor_{self.actor.id}_{self.actor.simulation.simulation_id}.json", line=f"{data},\n")
